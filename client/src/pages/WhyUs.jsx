    ...
    const text = {
        ...
        ZH: {
            ...
            sections: [
                {
                    title: "本地可靠性",
                    desc: "我们不仅是一家保险代理机构，更是您的邻居。我们深入了解春武里地区及当地的驾驶生活方式。这种专业知识使我们能够推荐既经济高效又能满足您具体需求的最佳保障方案。",
                    icon: Users
                },
                {
                    title: "透明与信任",
                    desc: "客户的信任是我们的核心价值。诚实永远是第一位的。我们清晰解释每一个保单细节，绝无隐藏条款，确保当意外发生时，您能获得所承诺的保障。",
                    icon: ShieldCheck
                },
                {
                    title: "卓越的全方位服务",
                    desc: "从比较一等、二等+或三等车险保费，到处理您的强制险 (Por Ror Bor) 和路税，我们提供一站式服务。我们的团队随时准备为您提供快速咨询和理赔协调，让您安心无忧。",
                    icon: Clock
                },
                {
                    title: "值得信赖的合作伙伴",
                    desc: "我们精挑细选泰国最稳定、声誉最好的保险公司，确保我们的客户获得国际标准的服务和财务安全。",
                    icon: Award
                }
            ],
            partners_title: "我们信赖的合作伙伴",
            reviews_title: "邻居们的评价",
            team_title: "认识我们的团队",
            team: [
                { name: "Chairoj", role: "保险专家", img: "/team/chairoj.png" },
                { name: "Fay", role: "保险专家", img: "/team/fay.png" },
                { name: "Mild", role: "保险专家" }
            ]
        }
    };
